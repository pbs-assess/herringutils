...
decision_tables_mp_add <- function(df,
  ...
  new_rows$command <- c(paste0(latex.cline("1-12"),
                        ...
                        paste0(latex.cline("3-10"),
                               ...
                               latex.amp(),
                               ifelse( translate,
                                       "$P(\\mli{BR}_t \\geq 0.65\\mli{BR}_0)$",
                                       "$P(\\mli{SB}_t \\geq 0.65\\mli{SB}_0)$"),
                               latex.amp(),
                               ifelse( translate,
                                       "$P(\\mli{BR}_t \\geq 0.75\\mli{BR}_0)$",
                                       "$P(\\mli{SB}_t \\geq 0.75\\mli{SB}_0)$"),
                               latex.amp(),
                               ifelse( translate,
                                       "$P(\\mli{BR}_t \\geq \\mli{BR}_\\text{MOY})$",
                                       "$P(\\mli{SB}_t \\geq \\mli{SB}_\\text{AVE})$"),
                               latex.amp(),
                               en2fr("AAV", translate = translate),
                               latex.amp(),
                               "$\\overline{C}$",
